...
if station == 'Gucheng':
    ...
    st.write('Menurut data yang diambil distasiun dongsi dapat disimpulkan bahwa kualitas udara di kota dongsi sehat.')  # Tambahkan deskripsi
    ...
    st.write('Menurut data yang diambil distasiun guanyuan dapat disimpulkan bahwa kualitas udara di kota guanyuan sehat.')  # Tambahkan deskripsi
